...
export const Image = ({
  ...
  return (
    ...
    >
        <div ref={el} className="flex border-y-2 border-[#A5A690]  border-t-0 justify-between ">
        <span className="font-helvetica font-bold uppercase py-2.5 px-4 text-sm ">{name}</span>
          <button className="border-x-2 border-r-0 border-[#A5A690] px-3 py-2 cursor-pointer">
